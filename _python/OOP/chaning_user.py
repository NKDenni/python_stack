...
Bob.make_deposite(1000).make_deposite(200).make_deposite(900).make_withdrawal(400).display_user_balance()
print("\n", "-"*20, "New Transaction", "-"*20)

John.make_deposite(300).make_deposite(2000).make_withdrawal(100).make_withdrawal(600).display_user_balance()
print("\n", "-"*20, "New Transaction", "-"*20)

Eric.make_deposite(5000).make_withdrawal(200).make_withdrawal(100).make_withdrawal(300).display_user_balance()
print("\n", "-"*20, "New Transaction", "-"*20)
